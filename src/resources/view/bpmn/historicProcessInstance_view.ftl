...
<table class="table table-bordered">
	...
	<tr>
		<td>
		<a href="<@url value="${actionNamespace}/task/downloadAttachment/${attachment.id}"/>" target="_blank">${attachment.name}</a>
		<a href="<@url value="${actionNamespace}/task/downloadAttachment/${attachment.id}"/>" download="${attachment.name}" style="margin-left:10px;"><i class="glyphicon glyphicon-download-alt"></i></a>
		</td>
