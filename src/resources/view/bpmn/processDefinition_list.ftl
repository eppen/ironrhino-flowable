...
<body>
<#assign columns={"processDefinition.id":{"alias":"流程定义ID","width":"150px","template":r'<a href="<@url value="${actionNamespace}/historicProcessInstance/list?processDefinitionId=${value}"/>" class="ajax view">${value}</a>'},
